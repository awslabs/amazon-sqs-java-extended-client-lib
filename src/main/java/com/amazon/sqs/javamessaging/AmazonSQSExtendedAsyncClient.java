...
public class AmazonSQSExtendedAsyncClient extends AmazonSQSExtendedAsyncClientBase implements SqsAsyncClient {
    ...
    public AmazonSQSExtendedAsyncClient(SqsAsyncClient sqsAsyncClient) {
        this(sqsAsyncClient, new ExtendedClientConfiguration());
    }
     ...
     */
    public AmazonSQSExtendedAsyncClient(SqsAsyncClient sqsAsyncClient, ExtendedClientConfiguration extendedClientConfig) {
     ...
     * @throws software.amazon.awssdk.services.sqs.model.UnsupportedOperationException
    ...
    public CompletableFuture<ReceiveMessageResponse> receiveMessage(ReceiveMessageRequest receiveMessageRequest) {
        ...
        try {
            receiveMessageResponse = super.receiveMessage(receiveMessageRequest).get();
        ...
        return CompletableFuture.completedFuture(receiveMessageResponseBuilder.build());
    }
