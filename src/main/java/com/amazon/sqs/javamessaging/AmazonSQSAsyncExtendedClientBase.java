...
abstract class AmazonSQSAsyncExtendedClientBase implements AmazonSQSAsync {
     ...
     * @param messageBody The message to send. String maximum 256 KB in size. For a list
     ...
     * </p>
     *
     * @param setQueueAttributesRequest Container for the necessary parameters to execute the
     ...
     * </p>
     *
     * @param removePermissionRequest Container for the necessary parameters to execute the
     ...
     * </p>
     *
     * @param getQueueAttributesRequest Container for the necessary parameters to execute the
     ...
     * </p>
     *
     * @param listDeadLetterSourceQueuesRequest Container for the necessary parameters to execute the
     ...
     * </p>
     *
     * @param deleteQueueRequest Container for the necessary parameters to execute the
     ...
     * </p>
     *
     * @param listQueuesRequest Container for the necessary parameters to execute the
     ...
     * </p>
     *
     * @param addPermissionRequest Container for the necessary parameters to execute the
    ...
    public ChangeMessageVisibilityBatchResult changeMessageVisibilityBatch(String queueUrl,
                                                                           List<ChangeMessageVisibilityBatchRequestEntry> entries) throws
     ...
     *
     * @param queueUrl          The URL of the Amazon SQS queue to take action on.
     * @param receiptHandle     The receipt handle associated with the message whose
     *                          visibility timeout should be changed. This parameter is
     *                          returned by the <a>ReceiveMessage</a> action.
     * @param visibilityTimeout The new value (in seconds - from 0 to 43200 - maximum 12
     ...
     *
     * @param queueUrl The URL of the Amazon SQS queue to take action on.
     * @param label    The identification of the permission to remove. This is the
     ...
     * </p>
     *
     * @param queueNamePrefix A string to use for filtering the list results. Only those
     ...
     *
     * @param queueUrl      The URL of the Amazon SQS queue to take action on.
     * @param label         The unique identification of the permission you're setting
     ...
     *                                side issue.
     */
    public AddPermissionResult addPermission(String queueUrl,
                                             String label,
     ...
     *
     * @param endpoint The endpoint (ex: "sqs.us-east-1.amazonaws.com") or a full URL,
     ...
     * @throws IllegalArgumentException If the given region is null, or if this service isn't
     ...
     */
    @Override
    public ListQueueTagsResult listQueueTags(final ListQueueTagsRequest listQueueTagsRequest) {
     ...
     */
    @Override
    public ListQueueTagsResult listQueueTags(final String queueUrl) {
     ...
     */
    @Override
    public TagQueueResult tagQueue(final TagQueueRequest tagQueueRequest) {
     ...
     */
    @Override
    public TagQueueResult tagQueue(final String queueUrl, final Map<String, String> tags) {
     ...
     */
    @Override
    public UntagQueueResult untagQueue(final UntagQueueRequest untagQueueRequest) {
     ...
     */
    @Override
    public UntagQueueResult untagQueue(final String queueUrl, final List<String> tagKeys) {
    ...
    @Override
    public Future<AddPermissionResult> addPermissionAsync(String queueUrl,
                                                          String label,
                                                          List<String> aWSAccountIds,
                                                          List<String> actions) {
    ...
    @Override
    public Future<GetQueueAttributesResult> getQueueAttributesAsync(String queueUrl,
    ...
    @Override
    public Future<RemovePermissionResult> removePermissionAsync(String queueUrl,
                                                                String label,
                                                                AsyncHandler<RemovePermissionRequest, RemovePermissionResult> asyncHandler) {
    ...
    @Override
    public Future<TagQueueResult> tagQueueAsync(String queueUrl,
    ...
    @Override
    public Future<UntagQueueResult> untagQueueAsync(String queueUrl,
                                                    List<String> tagKeys,
                                                    AsyncHandler<UntagQueueRequest, UntagQueueResult> asyncHandler) {
