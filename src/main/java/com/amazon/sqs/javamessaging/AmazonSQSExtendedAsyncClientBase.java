...
abstract class AmazonSQSExtendedAsyncClientBase implements SqsAsyncClient {
    ...
    public AmazonSQSExtendedAsyncClientBase(SqsAsyncClient sqsAsyncClient) {
        amazonSqsToBeExtended = sqsAsyncClient;
    }
     ...
     *      Documentation</a>
     */
    public CompletableFuture<GetQueueUrlResponse> getQueueUrl(GetQueueUrlRequest getQueueUrlRequest) throws AwsServiceException,
            SdkClientException {
     ...
     *      Documentation</a>
     */
    public CompletableFuture<ListQueuesResponse> listQueues(ListQueuesRequest listQueuesRequest) throws AwsServiceException,
            SdkClientException {
     ...
     *      Documentation</a>
     */
    public CompletableFuture<ListQueuesResponse> listQueues() throws AwsServiceException, SdkClientException {
    ...
    /** {@inheritDoc}
     * @return*/
    @Override public CompletableFuture<ListQueueTagsResponse> listQueueTags(final ListQueueTagsRequest listQueueTagsRequest) {
        return amazonSqsToBeExtended.listQueueTags(listQueueTagsRequest);
    }

    /** {@inheritDoc}
     * @return*/
    @Override public CompletableFuture<TagQueueResponse> tagQueue(final TagQueueRequest tagQueueRequest) {
        return amazonSqsToBeExtended.tagQueue(tagQueueRequest);
    }

    /** {@inheritDoc}
     * @return*/
    @Override public CompletableFuture<UntagQueueResponse> untagQueue(final UntagQueueRequest untagQueueRequest) {
